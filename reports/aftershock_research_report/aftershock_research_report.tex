...
\begin{titlepage}
  ...
  \centering
  \vspace*{0.05cm}
  \IfFileExists{figures/pku_logo_wordmark.png}{\includegraphics[width=8.7cm]{pku_logo_wordmark.png}\par}{\vspace*{1cm}}
  \vspace{2.70cm}
  ...
  \begin{tabular}{@{}p{2.35cm}p{10.65cm}@{}}
    {\zihao{4}\songti 课程：} & \underline{\makebox[10.65cm][c]{\zihao{4}\songti 人工智能导论（待填写）}} \\[1.25em]
    {\zihao{4}\songti 姓名：} & \underline{\makebox[10.65cm][c]{\zihao{4}\songti 待填写}} \\[1.25em]
    {\zihao{4}\songti 学号：} & \underline{\makebox[10.65cm][c]{\zihao{4}\songti 待填写}} \\[1.25em]
    {\zihao{4}\songti 组别：} & \underline{\makebox[10.65cm][c]{\zihao{4}\songti 待填写}} \\[1.25em]
...
\begin{table}[H]
  ...
  \input{tables/feature_groups.tex}
\end{table}
...
\begin{table}[H]
  ...
  \input{tables/feature_validity.tex}
\end{table}
...
\begin{center}
\input{tables/cv_fold_metrics.tex}
...
\begin{table}[H]
  ...
  \input{tables/model_mean_metrics.tex}
\end{table}
...
\begin{center}
\input{tables/submission_results.tex}
...
\begin{table}[H]
  ...
  \input{tables/module_structure.tex}
\end{table}
